...
//			System.out.println(e.getMessage());
    ...
    public static Date getPreHour() {
        return new Date(System.currentTimeMillis() - 3600 * 1000L);
    }
    ...
    public static Date getPreYesterday() {
        return new Date(System.currentTimeMillis() - 48 * 3600 * 1000L);
    }
     ...
     * 获取Next Second
     */
    public static String getNextSecond(Object date, int amount) {
        SimpleDateFormat frm = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar calendar = Calendar.getInstance();
        try {
            if (date instanceof String) {
